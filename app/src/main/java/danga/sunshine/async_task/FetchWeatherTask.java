...
public class FetchWeatherTask extends AsyncTask <String, Void, String[]> {
    ...
    protected String[] doInBackground(String... postcode) {
        ...
        if (postcode.length == 0) {
            Log.w("postcode", "there is no post code");
            return null;
        }
        int numOfDays = 7;
        String forecastJsonStr = getForecastJsonStr(postcode[0], numOfDays);

        String[] ans = null;
        try {
            ans = getWeatherDataFromJson(forecastJsonStr,numOfDays);
    ...
    protected void onPostExecute(String[] weatherForecast) {
        if(weatherForecast != null) {
            arrayAdapter.clear();
            for (String oneItem : weatherForecast) {
                arrayAdapter.add(oneItem);
            }
        }
    }
    ...
    // private methods
    //-----------------------------------------------------------------------------------
    private String getForecastJsonStr(String postcode, int numOfDays) {
    ...
    }//close method getWeatherDataFromJson

}// close class FetchWeatherTask
